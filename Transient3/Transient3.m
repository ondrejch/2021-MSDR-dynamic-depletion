...
%% Transient - 3
%%% Runs a simultanious OSTG trip, 2/3 loop trip, DHRS turn on and SCRAM (-2000pcm)
%%% Simulation done in two steps

%%% Step - 1; Simulation is run for 2000[s] at 750[Mw_t]
%%% Step - 2; Simultanious OSTG trip, 2/3 loop trip, DHRS turn on and SCRAM

%% User Inputs Start

%%% Basic Simulation Parameters
P = 750;                                                                   %Operational thermal power [MW]
simtime = 16000;                                                           %Simulation time [s]
...
reactdata = [0 0 -1.4e-2 -1.4e-2];                                         %Reactivity insertions [abs]
reacttime = [0 2000 2000 simtime];                                         %Reactivity insertion time [s]
...
Trip_P2_pump = 2000;                                                       %Time at which primary pump 2 is tripped [s]
Trip_P3_pump = 2000;                                                       %Time at which primary pump 3 is tripped [s]

%%% Secondary Pump Set
Trip_S1_pump = 2000000;                                                    %Time at which secondary pump 1 is tripped [s]
Trip_S2_pump = 2000;                                                       %Time at which secondary pump 2 is tripped [s]
Trip_S3_pump = 2000;                                                       %Time at which secondary pump 3 is tripped [s]

%%% Tertiary Pump Set
Trip_T1_pump = 2000000;                                                    %Time at which tertiary pump 1 is tripped [s]
Trip_T2_pump = 2000;                                                       %Time at which tertiary pump 2 is tripped [s]
Trip_T3_pump = 2000;                                                       %Time at which tertiary pump 3 is tripped [s]
