...
for i in depletion_range:
    ...
    depl_script = " %%MSDR Transient3 Depletion Point\n\
    \n\
    addpath('~/MSDR_with_DHnDepl/Transient3/scripts')\n\
    \n\
    depletion_time = "+'{:.0f}'.format(i)+"; \n\
    \n\
    run('Transient3.m');  %transient parameter file \n\
    \n\
    run('savedata_Transient3.m'); \n\
    \n\
    ...
    bashCommand3 = "cd ~/MSDR_with_DHnDepl/Transient3/scripts"
