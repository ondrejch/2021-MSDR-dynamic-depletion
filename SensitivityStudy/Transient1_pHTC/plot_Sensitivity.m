...
run('all_pHTC_sen5_depl_results_Transient1.m')
run('all_pHTC_sen10_depl_results_Transient1.m')
run('all_pHTC_sen25_depl_results_Transient1.m')
run('all_pHTC_sen50_depl_results_Transient1.m')
run('all_pHTC_senN5_depl_results_Transient1.m')
run('all_pHTC_senN10_depl_results_Transient1.m')
run('all_pHTC_senN25_depl_results_Transient1.m')
run('all_pHTC_senN50_depl_results_Transient1.m')
...
legend('BOC', 'Normal EOC', '+5% HTC @ EOC', '+10% HTC @ EOC', '+25% HTC @ EOC', '+50% HTC @ EOC', '-5% HTC @ EOC', '-10% HTC @ EOC', '-25% HTC @ EOC', '-50% HTC @ EOC','BOC Reactivity','EOC Reactivity')
...
legend('Normal', '+25% pHTC', '+50% pHTC', '-25% pHTC', '-50% pHTC')
xlim([0 3650])
ylim([-inf inf])
